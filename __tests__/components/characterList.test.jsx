...
describe('Component', () => {
  it('CharacterList component renders correctly', () => {
    render(<CharacterList />)
    const characterList = screen.getByTestId('character-list-component')
  ...
  it('CharacterList renders loading with invalid data',()=>{
    render(<CharacterList />)
    const characterList = screen.getByTestId('character-list-loading')
    expect(characterList).toBeTruthy()
  })
})
