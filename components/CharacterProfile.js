...
function CharacterProfile({ characterData }) {
      ...
      <ul className="min-w-10 max-w-full">
        ...
        <li>
          <div className="flex items-center text-base font-medium">
            ...
            >
              <button
                className={`truncate bg-yellow-300 dark:bg-yellow-700 px-4 my-2 rounded-2xl shadow-lg hover:scale-105 transition transform duration-200 ease-out hover:animate-pulse font-medium text-black dark:text-white`}
              >
  ...
  let episodesMarkup = characterData
    ? characterData.episode.map((episode, index) => (
        ...
        >
          <button
            className={`truncate w-32 bg-yellow-300 dark:bg-yellow-700 px-4 py-2 rounded-2xl shadow-lg hover:scale-105 transition transform duration-200 ease-out hover:animate-pulse font-semibold text-black dark:text-white`}
          >
            <p className="truncate text-gray-700 dark:text-gray-300  sm:max-w-full text-wrap">
              Episode{" "}
